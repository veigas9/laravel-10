                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 text-sm whitespace-nowrap flex">
                                ...
                                <a href="{{ route('supports.edit', $support->id) }}" title="Editar" class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg">
                                    Editar
                                </a>
                                @endcan
                                <a href="{{ route('replies.index', $support->id) }}" title= "Iteração/Deletar" class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg">
